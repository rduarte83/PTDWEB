				...
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail" class="item-blog-img pos-relative dis-block hov-img-zoom">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="blog-detail" class="m-text24">
								...
								<a href="blog-detail" class="s-text20">
									Continue Reading
					...
					<div class="rightbar">
						...
						<ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="product-detail" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
