                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-body">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="font-weight-bold">Compra efetuada com sucesso <span class="glyphicon glyphicon-thumbs-up"></span></h5>
                                    </div>
                                    <div class="card-body">
                                        <p>Use o código nesta página para levantar a suabotija em quarquer ponto de recolha.</p>
                                    </div>
                        </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <img class="class= img-thumbnail text-center" style="width:150px;height:100px;" src="../images/codigobarras.png" alt="Código de barras">
